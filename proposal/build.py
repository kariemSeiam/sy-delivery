...
ORDER = ["01-02.html", "03-04.html", "05.html", "06-demo.html", "07-08.html", "09.html", "10.html", "11.html", "12.html", "13.html", "14.html", "15.html", "16-cost.html", "17.html", "18.html", "20.html"]
...
TOC = [
    ...
    ("ch07", "الأركتكتشر: مضيف الأصداف", True),
    ("ch08", "العمود الفقري للتصنيف", True),
    ("ch09", "الأسطح: إيه اللي بيتبني", True),
    ("ch10", "الفشل هو المنتج", True),
    ("ch11", "الهوية والدخول", True),
    ("ch12", "الفلوس: الليدجر والعملة", True),
    ("ch13", "التوزيع: إزاي التطبيق يوصل", True),
    ("ch14", "الإطلاق: أول ٢٠ تاجر", True),
    ("ch15", "المراحل والبوابات", True),
    ("ch16", "التكلفة التشغيلية", True),
    ("ch17", "القانون والكيان", True),
    ("ch18", "المخاطر بصراحة", True),
    ("ch19", "التعاقد", False),
    ("ch20", "الملاحق والمصادر", True),
]
